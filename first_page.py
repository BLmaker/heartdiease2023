...
class FirstPage:
    ...
    def __init__(self, root,id_num):
        ...
        self.cp_label.grid(row=3, column=2)
        ...
        self.rbp_label.grid(row=4, column=2)
        self.rbp_entry = tk.Entry(User_frame)
        self.rbp_entry.grid(row=4, column=3)
    
        #rbp1=float(rbp_entry)
    
        self.chl_label = tk.Label(User_frame, text="[3] Cholestoral in mg/dl:")
        self.chl_label.grid(row=5, column=2)
        self.chl_entry = tk.Entry(User_frame)
        self.chl_entry.grid(row=5, column=3)
    
        #chl1=float(chl_entry)
    
        self.fbs_label = tk.Label(User_frame, text="[4] If fasting Blood Sugar: > 120mg/L , then 1, otherwise 0")
        self.fbs_label.grid(row=6, column=2)
        ...
        self.restecg_label.grid(row=7, column=2)
        ...
        self.thalach_label.grid(row=8, column=2)
        self.thalach_entry = tk.Entry(User_frame)
        self.thalach_entry.grid(row=8, column=3)
    
    
        #thalach1=float(thalach_entry)
    
        self.exang_label = tk.Label(User_frame, text="[7] Exercise Induced Angina (1 = Yes, 0 = No):")
        self.exang_label.grid(row=9, column=2)
    ...
    def submit(self):
        ...
        #   age_entry.get(),
         #  sex_entry.get(),
            ...
            self.chl_entry.get(),
            self.fbs_entry.get(),
            self.restecg_entry.get(),
            self.thalach_entry.get(),
            self.exang_entry.get(),
            self.oldpeak_entry.get(),
            self.slope_entry.get(),
        ]
        #cp1=cp_entry.get()
